package com.gzeinnumer.recyclerviewlistviewsortitemalphabetically;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void createExampleList() {
        ...
        mExampleList.add(new ExampleItem(R.drawable.ic_android, "Rick", "Grimes"));
        mExampleList.add(new ExampleItem(R.drawable.ic_android, "Abraham", "Ford"));
